            ...
            <div className="container my-5 max-w-xl mx-auto">
                <div className="shadow p-4">
                    ...
                    <form action="" onSubmit={handleSubmit} className="my-3">
                        <div className="my-3">
                            <input type="text" name="name" value={users.name} onChange={onChangeHandler} className="rounded w-full px-2 py-2 border outline-green-400 text-xl" placeholder="Enter your name" />
                        </div>
                        <div className="my-3">
                        ...
                        <button className="rounded-md  px-6 py-2 border bg-green-400 hover:bg-green-600 text-md text-white" >Sign up</button>
                    </form>
                </div>
            </div>
        </div>
